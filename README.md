# É um  código em python para envio de e-mail em massa
...
na var *psw* você insere a senha;
na var *remet* você define quem vai enviar os e-mails;
na var *destinatarios* você define pra quem os e-mails serão enviados. 